...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("How to Deploy?", url="https://t.me/nevergiveuph"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/joinchat/41S4Mja2ERgyYTQ1"),
                    InlineKeyboardButton("Support Group", url="https://t.me/South_Indian_Hindi_mv")
                ]
            ]
        )
